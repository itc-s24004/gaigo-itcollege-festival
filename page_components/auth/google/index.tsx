...
export function GoogleAuthBtn({type, text = "Sign in with Google", customAttributes}: Props) {
    return (
        <button type={type} className={styles["gsi-material-button"]} {...customAttributes}>
